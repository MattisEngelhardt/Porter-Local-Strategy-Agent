...
> **▶ [M&A evaluation deck — Figure AI as a target for Neura (PPTX)](output/2026-06-02_evaluate_figure_ai_as_a_potential_m_a_target_for_n_deck.pptx)**
> — our latest and best end-to-end run. Click to download/view.
> <!-- BEST_DEMO_PPTX:END -->
>
> More sample deliverables (one per format, generated by real test runs):
> - 📊 PowerPoint deck — see the best demo above
> - 📄 PDF brief — [Figure AI competitive / strategic-threat analysis](output/2026-06-01_competitive_analysis_figure_ai_strategic_threat_an_brief.pdf)
> - 📈 Excel workbook — [business-case financial model](output/2026-06-01_develop_a_comprehensive_business_case_analyzing_th_business_case.xlsx)
> - 📝 Markdown briefing — [Q2 2026 performance review](output/2026-05-31_q2_2026_performance_review_financial_health_and_st_briefing.md)
>
> _These are synthetic demo runs, not real business data. The deck above swaps automatically whenever a new run scores higher with the built-in output critic._
